...
export const personalInfo = {
  ...
  description: "Creating an Innovative, Functional, and User-Friendly Website for Digital Solutions.",
  typingPhrases: ["Information Technology", "Software Engineering", "Web Developer"],
...
export const socialLinks = {
  ...
  SiUpwork: "https://www.upwork.com/freelancers/~019beb4f8915848602?mp_source=share",
...
export const projects = [
  {
    ...
    description: "A comprehensive task management system with dashboard overview, calendar scheduling, and detailed task tracking features...",
    fullDescription: "A modern task management application designed to help users organize, track, and complete their tasks efficiently. Features include an intuitive dashboard with progress statistics, calendar view for scheduling, detailed task cards with checklists, priority levels, and team collaboration tools.",
    ...
    details: [
      {
        ...
        content: "Get a quick summary of your tasks and overall progress with beautiful statistics cards showing total tasks (128), completed tasks (76), pending tasks (52), and overall progress (59%). The dashboard provides an at-a-glance view of your productivity with visual progress bars and real-time updates."
      },
      {
        title: "Task Details & Management",
        content: "All the important info about a task in one place. Each task card includes a detailed description, checklist with progress tracking (2/4 completed), due dates (May 28, 2024), priority levels (High/Medium/Low), assignee information (Ava Smith), tags (UI, Dashboard, Frontend), and quick actions to edit or mark tasks as complete."
      },
      {
        title: "Calendar / Schedule View",
        content: "See deadlines and plan your work efficiently with the integrated calendar view. Switch between week and month views, visualize tasks on specific dates with color-coded labels (Design Review, API Integration, Client Call, Dashboard Deadline, Testing Sprint, Project Demo), and never miss important deadlines with the intuitive scheduling interface."
      }
    ],
    link: null,
    available: false
  },
  {
    ...
    description: "A modern news portal with homepage hero section, article pages with rich content, and comprehensive admin panel for content management...",
    fullDescription: "A fully-featured news portal website with responsive design, featuring a dynamic homepage with breaking news, top stories sidebar, trending articles section, detailed article pages with author information and social sharing, and a powerful admin content management system for creating, editing, and publishing articles with categories, tags, and scheduling capabilities.",
  ...
  },
  {
    ...
    description: "A comprehensive e-commerce management system with analytics dashboard, order management, and secure payment checkout...",
    fullDescription: "A complete e-commerce admin platform featuring powerful analytics dashboard with sales tracking and insights, order management system for tracking customer orders with multiple status filters, and seamless payment checkout page with multiple payment options including cash on delivery, credit/debit cards, UPI, and wallet payments.",
...
export const education = [
  {
    ...
    subtitle: "Bachelor Degree of Software Engineering, at BELTEI International University ",
    period: "2022 - Present"
  },
  {
